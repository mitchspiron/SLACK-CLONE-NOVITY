<template>
  <div class="flex flex-col h-full w-3/6 bg-gray-600 px-4 py-6">
    <div
      class="flex flex-row items-center py-4 px-6 rounded-2xl shadow bg-gray-50 dark:bg-gray-700"
    >
      <div
        class="flex items-center justify-center h-10 w-10 rounded-full bg-green-500 text-pink-100"
      >
        #
      </div>
      <div class="flex flex-col ml-3">
        <div class="font-semibold text-sm">CODEUR MADA</div>
        <div class="text-xs text-gray-500">17 membres</div>
      </div>
      <div class="ml-auto">
          ...
          <div class="col-start-1 col-end-8 p-3 rounded-lg">
            <div class="flex items-start gap-2.5">
              ...
              <div class="flex flex-col w-full max-w-[320px] leading-1.5">
                ...
                <p
                  class="text-sm font-normal py-2 text-gray-900 dark:text-white"
                >
